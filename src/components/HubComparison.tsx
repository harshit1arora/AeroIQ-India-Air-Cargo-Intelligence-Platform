...
const airportData = {
  DEL: { name: "Delhi", growth: 19, volume: 920, top: "Electronics" },
  BOM: { name: "Mumbai", growth: 11, volume: 850, top: "Pharma" },
  BLR: { name: "Bengaluru", growth: 16, volume: 410, top: "Perishables" },
  HYD: { name: "Hyderabad", growth: 14, volume: 380, top: "Pharma" },
  MAA: { name: "Chennai", growth: 12, volume: 350, top: "Automotive" },
};
